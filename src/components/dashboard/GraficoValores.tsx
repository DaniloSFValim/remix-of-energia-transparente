...
import { ZoomIn, ZoomOut, RotateCcw, DollarSign } from 'lucide-react';
              ...
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={dados} margin={{ top: 20, right: 60, left: 20, bottom: 40 }}>
                  ...
                  <ReferenceLine 
                    ...
                    strokeDasharray="5 5" 
                    label={{ value: `Média: R$ ${formatYAxis(mediaValor)}`, fill: 'hsl(var(--muted-foreground))', fontSize: 12 }}
                  />
                  <Line 
                    type="monotone" 
                    dataKey="valor" 
      ...
      <CardContent>
        <div className="h-[300px]">
          {dados.length === 0 ? (
            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={dados} margin={{ top: 10, right: 50, left: 10, bottom: 30 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="hsl(var(--border))" opacity={0.4} />
                <XAxis 
                  dataKey="periodo" 
